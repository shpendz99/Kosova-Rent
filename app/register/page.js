...
export default function page() {
  return (
    <div className="bg-[#fdfdfd] h-screen flex relative max-sm:px-4">
      ...
      <div className="relative flex flex-row-reverse w-full max-w-sm m-auto overflow-hidden bg-white rounded-2xl shadow-2xl lg:max-w-4xl">
        <div className="hidden relative bg-cover sm:block sm:w-1/2 sm:overflow-hidden  ">
          <div className="group">
            <Image src={Porche} fill objectFit="cover" className="group-hover:scale-105 transition duration-1000 ease-in-out" />
